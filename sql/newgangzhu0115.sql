...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='璐﹀崟琛';
...
CREATE TABLE `hz_commitment` (
  ...
  KEY `idx_tenant_id` (`tenant_id`),
  KEY `idx_project_id` (`project_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='鎵胯?涔﹁〃';
...
-- Records of hz_user
-- ----------------------------
INSERT INTO `hz_user` VALUES ('1', '13800138001', '18296541256', '1', 'wx_test_001', null, null, '微信测试用户', '/profile/avatar/default.jpg', '陈庆志', '0', '410623199602255325', null, '1', '郑州港区投资集团', '037166525654', '无', '/profile/upload/2026/01/13/s1024407_20260113150722A001.jpg', 'wechat', '1', '0', '2026-01-15 02:53:53', '127.0.0.1', '0', 'admin', '2026-01-13 01:55:13', null, null, '微信登录测试账号');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '/profile/avatar/2025/11/17/54d9ef312c7142caa37ac2ecdddb0973.png', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-01-15 00:40:11', '2025-11-17 18:04:01', 'admin', '2025-11-17 18:04:01', '', '2025-11-17 19:06:19', '管理员');
