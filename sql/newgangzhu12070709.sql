...
CREATE TABLE `hz_building` (
  ...
  KEY `idx_project_id` (`project_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='妤兼爧琛';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='鎴挎簮琛';

-- ----------------------------
-- Records of hz_house
-- ----------------------------
INSERT INTO `hz_house` VALUES ('1', '2', '3', '5', '123', '456', '1', null, '一室一厅', '60.00', '2000.00', '3000.00', '南', null, null, '0', '0', '0', '0', '', null, '', null, null, '0');
...
CREATE TABLE `hz_house_image` (
  ...
  `image_type` char(1) DEFAULT '1' COMMENT '鍥剧墖绫诲瀷(1:瀹炴櫙鍥?2:鎴峰瀷鍥?',
  ...
  KEY `idx_house_id` (`house_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='鎴挎簮鍥剧墖琛';
...
CREATE TABLE `hz_house_type` (
  ...
  KEY `idx_project_id` (`project_id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='鎴峰瀷琛';
...
CREATE TABLE `hz_house_vr` (
  ...
  PRIMARY KEY (`vr_id`),
  KEY `idx_house_id` (`house_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='鎴挎簮VR琛';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='椤圭洰琛';

-- ----------------------------
-- Records of hz_project
-- ----------------------------
INSERT INTO `hz_project` VALUES ('1', '阿斯蒂芬', '012', '1', '阿斯蒂芬', '123.1210000', '21.1212000', '0', '0', '0', '阿斯蒂芬', '阿斯蒂芬', '阿斯蒂芬', null, 'wenwang', '18539279011', '0', '0', '', null, '', null, null, '0');
INSERT INTO `hz_project` VALUES ('2', '测试1', '56', '1', '阿斯蒂芬', '0.0000000', '0.0000000', '50', '500', '200', null, null, null, null, '菜', '18539279011', '0', '2', '', null, '', null, null, '0');
...
CREATE TABLE `hz_unit` (
  ...
  KEY `idx_building_id` (`building_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='鍗曞厓琛';
...
) ENGINE=InnoDB AUTO_INCREMENT=1302 DEFAULT CHARSET=utf8 COMMENT='字典数据表';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '/profile/avatar/2025/11/17/54d9ef312c7142caa37ac2ecdddb0973.png', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-12-06 18:46:46', '2025-11-17 18:04:01', 'admin', '2025-11-17 18:04:01', '', '2025-11-17 19:06:19', '管理员');
