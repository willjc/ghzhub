...
CREATE TABLE `hz_house_type` (
  ...
  KEY `idx_project_id` (`project_id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='鎴峰瀷琛';
...
INSERT INTO `hz_house_type` VALUES ('17', '3', '一室一厅', 'yishiyiting', '1', '1', '1', '1', '1', '60.00', null, '0', '0', '', null, '', null, null, '0');
...
-- Records of hz_user
-- ----------------------------
INSERT INTO `hz_user` VALUES ('1', '13800138001', '18296541256', '1', 'wx_test_001', null, null, '微信测试用户', '/profile/avatar/default.jpg', '陈庆志', '0', '410623199602255325', null, '1', '郑州港区投资集团', '037166525654', '无', '/profile/upload/2026/01/13/s1024407_20260113150722A001.jpg', 'wechat', '1', '0', '2026-01-13 22:44:27', '127.0.0.1', '0', 'admin', '2026-01-13 01:55:13', null, null, '微信登录测试账号');
INSERT INTO `hz_user` VALUES ('2', '13800138002', null, '2', null, null, 'zhb_test_001', '郑好办测试用户', '/profile/avatar/default.jpg', null, '0', null, null, null, null, null, null, null, 'zhenghaoban', '0', '0', '2026-01-13 15:18:00', '127.0.0.1', '0', 'admin', '2026-01-13 01:55:13', null, null, '郑好办登录测试账号');
...
) ENGINE=InnoDB AUTO_INCREMENT=217 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '/profile/avatar/2025/11/17/54d9ef312c7142caa37ac2ecdddb0973.png', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-01-13 22:15:56', '2025-11-17 18:04:01', 'admin', '2025-11-17 18:04:01', '', '2025-11-17 19:06:19', '管理员');
