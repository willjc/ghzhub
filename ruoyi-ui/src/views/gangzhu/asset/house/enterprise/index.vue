  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="batchList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="批次状态" align="center" prop="batchStatus" width="100">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.batchStatus === '0'" type="info" size="small">待分配</el-tag>
          <el-tag v-else-if="scope.row.batchStatus === '1'" type="primary" size="small">分配中</el-tag>
          <el-tag v-else-if="scope.row.batchStatus === '2'" type="success" size="small">已完成</el-tag>
          <span v-else style="color: #C0C4CC;">-</span>
        </template>
      </el-table-column>
